            ...
            <main className="container py-24 px-4 md:px-6 max-w-4xl mx-auto relative z-10">
                ...
                <div className="space-y-12">
                    <div className="text-center md:text-left">
                        <h1 className="text-5xl font-black tracking-tight mb-4 text-white">Politique de Confidentialité</h1>
                    ...
                    <div className="space-y-8 glass-card p-8 md:p-12 rounded-3xl border-none">
                        <section>
                            <h2 className="text-2xl font-bold mb-4 text-white">1. Informations que nous collectons</h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold mb-4 text-white">2. Comment nous utilisons vos informations</h2>
                            <ul className="list-disc pl-6 space-y-2 text-white/70 leading-relaxed marker:text-primary">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold mb-4 text-white">3. Partage des informations</h2>
                            <p className="text-white/70 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold mb-4 text-white">4. Sécurité des Données</h2>
                            <p className="text-white/70 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold mb-4 text-white">6. Contactez-nous</h2>
                            <p className="text-white/70 leading-relaxed">
